...
<html lang="ru">
  <head>
    ...
    <title>Aliance Production - О компании</title>
  </head>
  <body>
    ...
    <header class="header-interior header-bg-img">
      <div class="header-content-wrapper">
        <div class="container">
          <div class="header-interior-content">
            <div class="header-interior-info">
              <div class="seporator"></div>
              <h1 class="header-content-title header-content-title-dark">о компании</h1>
              <nav class="nav-interior-wrapper">
                <div class="breadcrumb">
                  <a href="/index.php" class="breadcrumb-link-home">Главная</a>
                  <a href="/about.php" class="breadcrumb-link">О компании</a>
                </div>
              </nav>
            </div>
          <!-- /.header-content -->
